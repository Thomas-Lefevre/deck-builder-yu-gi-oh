 ...
 */
final class Version20200617103721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE deck_card (id INT AUTO_INCREMENT NOT NULL, nbr INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE card ADD deck_card_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card ADD CONSTRAINT FK_161498D3CE42AF5C FOREIGN KEY (deck_card_id) REFERENCES deck_card (id)');
        ...
        $this->addSql('ALTER TABLE deck ADD CONSTRAINT FK_4FAC3637CE42AF5C FOREIGN KEY (deck_card_id) REFERENCES deck_card (id)');
